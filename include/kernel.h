...
namespace exafmm {
  namespace kernel {
    ...
    void P2P(C_iter Ci, J_iter Cj, bool mutual);                //!< P2P kernel between cells Ci and Cj
    ...
    template <typename J_iter>
    void M2L(C_iter Ci, J_iter Cj, bool mutual);                //!< M2L kernel between cells Ci and Cj
